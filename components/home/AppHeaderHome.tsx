      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 3 }}>
            ...
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.45)" strokeWidth="2.2" strokeLinecap="round">
              <path d="M6 9l6 6 6-6"/>
            </svg>
          </div>
        ...
        {/* Pannello ricerca */}
        {searchOpen && (
          <div style={{ padding: '8px 14px 12px', borderTop: '0.5px solid rgba(255,255,255,0.06)', background: '#0a0d18' }}>
            <div style={{
